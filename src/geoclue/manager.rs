// This code was autogenerated with `dbus-codegen-rust -c nonblock -m None -s -d org.freedesktop.GeoClue2 -p /org/freedesktop/GeoClue2/Manager -i org.freedesktop.DBus.`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
pub trait OrgFreedesktopGeoClue2Manager {
    fn get_client(&self) -> nonblock::MethodReply<dbus::Path<'static>>;
    fn create_client(&self) -> nonblock::MethodReply<dbus::Path<'static>>;
    fn delete_client(&self, client: dbus::Path) -> nonblock::MethodReply<()>;
    fn add_agent(&self, id: &str) -> nonblock::MethodReply<()>;
    fn in_use(&self) -> nonblock::MethodReply<bool>;
    fn available_accuracy_level(&self) -> nonblock::MethodReply<u32>;
}

impl<'a, T: nonblock::NonblockReply, C: ::std::ops::Deref<Target=T>> OrgFreedesktopGeoClue2Manager for nonblock::Proxy<'a, C> {
    ...
    fn in_use(&self) -> nonblock::MethodReply<bool> {
        <Self as nonblock::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.GeoClue2.Manager", "InUse")
    }

    fn available_accuracy_level(&self) -> nonblock::MethodReply<u32> {
        <Self as nonblock::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.GeoClue2.Manager", "AvailableAccuracyLevel")
    }
}
